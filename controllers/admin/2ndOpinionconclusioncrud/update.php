...
if(noError($conn)){
    ...
    if(isset($_SESSION["admin"]) && !in_array($_SESSION["admin"], $blanks)){
       ...
       $newQuestionGetMedicine = cleanQueryParameter($conn,$_POST["GetMedicine"]);
        $questionId = cleanQueryParameter($conn,$_POST["questionId"]);
        $editQuestion = editQuestion($newQuestionName,$newQuestionConclusion,$newQuestionFG,$newQuestionFP,$newQuestionFE,$newQuestionSG,$newQuestionSP,$newQuestionSE,$newQuestionFHS,$newQuestionSHS,$newQuestionGetMedicine,$questionId, $conn);
