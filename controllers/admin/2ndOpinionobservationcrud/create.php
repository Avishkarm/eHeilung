...
if(noError($conn)){
    ...
    if(isset($_SESSION["admin"]) && !in_array($_SESSION["admin"], $blanks)){
        ...
        $newQuestion = addNewObservations($newQuestionConclusion,$newQuestionFG,$newQuestionFP,$newQuestionFE,$newQuestionSG,$newQuestionSP,$newQuestionSE,$newQuestionFHS,$newQuestionSHS,$newQuestionGetMedicine, $conn);
        if(noError($newQuestion)){
            ...
            $returnArr["Record"]=array("questionId"=>$newQuestion["errMsg"],
                                 ...
                                 "fh_s"=>$newQuestionFHS,
                                 "sh_s"=>$newQuestionSHS,
                                 "conclusionStatus"=>$newQuestionGetMedicine
                                 );
