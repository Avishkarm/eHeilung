...
$dbname = "hansinfo_eheilung"; 
$username = "root"; 
// $password = "@!!!@#$%^eheilung.com@!"; 
$password = "darshan"; 
$secret="gaLFGASDI123542UJZZX@#$35dfgg"; 

$tokenExpiryTime=60*60; 
$adminUserName = "admin"; 
$adminPassword = "NitinShreepad"; 
$PatientMessageLimit="300"; 
$ContactEmail="mahesh.nijai@gmail.com";
$FeedbackEmail = "shreepadkhedekar@me.com";

//root url
//$rootUrl="http://103.224.241.131";
//$rootUrl="http://eheilung.com";
$rootUrl="https://eheilung.com"; 

//mail send via mailgun or php mail /// 
$mailSender="php_mail";
//$mailSender="mailGun"; 

//$blogurl="http://103.224.241.131/ehblog";
//$blogurl="http://eheilung.com/ehblog";
$blogurl="https://eheilung.com/ehblog";

//Google Analiytics
$EnbGA = true;

$Syphilis="Syphilis is one type of miasm"; $Sycosis="Sycosis is one type of miasm"; $Psora="Psora is one type of miasm";
 //$datetime=setTimezone(new DateTimeZone('Asia/Calcutta')); //print $datetime->format('Y-m-d H:i:s (e)');

 $logPath=array(); $logPath['signUp']="../logs/signUp/"; 
$logPath['login']="../logs/login/"; $logPath['userProfile']="../logs/userProfile/";
...
/* function noError Purpose: To check error arrays for no error state Arguments: The error array returned by any function Returns: True/False
*/
...
$sessionTimeout = 60; $resultsPerPage = 10; $captchaPublickey = ""; $captchaPrivatekey = ""; $tokenExpiryTime = 60*60;
$blanks= array("", " ", '', ' ');

/* function PrintArray Purpose: Text in a pre element is displayed in a fixed-width font, and it preserves both spaces and line breaks Arguments: $arr prints the text element
*/
...
$states_arr = array('AL'=>"Alabama",'AK'=>"Alaska",'AZ'=>"Arizona",'AR'=>"Arkansas",'CA'=>"California",'CO'=>"Colorado",'CT'=>"Connecticut",'DE'=>"Delaware",'DC'=>"District Of 
Columbia",'FL'=>"Florida",'GA'=>"Georgia",'HI'=>"Hawaii",'ID'=>"Idaho",'IL'=>"Illinois", 'IN'=>"Indiana", 'IA'=>"Iowa", 
'KS'=>"Kansas",'KY'=>"Kentucky",'LA'=>"Louisiana",'ME'=>"Maine",'MD'=>"Maryland", 
'MA'=>"Massachusetts",'MI'=>"Michigan",'MN'=>"Minnesota",'MS'=>"Mississippi",'MO'=>"Missouri",'MT'=>"Montana",'NE'=>"Nebraska",'NV'=>"Nevada",'NH'=>"New Hampshire",'NJ'=>"New 
Jersey",'NM'=>"New Mexico",'NY'=>"New York",'NC'=>"North Carolina",'ND'=>"North Dakota",'OH'=>"Ohio",'OK'=>"Oklahoma", 'OR'=>"Oregon",'PA'=>"Pennsylvania",'RI'=>"Rhode Island",'SC'=>"South 
Carolina",'SD'=>"South Dakota",'TN'=>"Tennessee",'TX'=>"Texas",'UT'=>"Utah",'VT'=>"Vermont",'VA'=>"Virginia",'WA'=>"Washington",'WV'=>"West Virginia",'WI'=>"Wisconsin",'WY'=>"Wyoming", 
'AS'=>'American Samoa', 'DC'=>'District of Columbia', 'GU'=>'Guam', 'MP'=>'Northern Marina Islands', 'PR'=>'Puerto Rico', 'VI'=>'U.S. Virgin Islands');


/* function cleanQueryParameter Purpose: To clean inputs to queries in order to prevent SQL Injection Attacks
		 This function must always (with few exceptions) be used to make data safe before sending a query to MySQL. Arguments: The parameter to be cleaned Returns: The escaped 
parameter */ /* function cleanDisplayParameter Purpose: To clean outputs to screen in order to prevent XSS Attacks Arguments: The parameter to be cleaned Returns: The escaped parameter */ 
...
/* function sendMail Purpose: To send emails Arguments: The from and to email addresses, subject and message Returns: error array
*/
