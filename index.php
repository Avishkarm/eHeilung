...
.top35{
  ...
  @media screen and (max-width: 992px)  {
        #demoVideoPhn {display:block;} 
        #demoVideoDsk {display:none; }   
  }
  @media screen and (min-width: 993px)  {
        #demoVideoPhn {display:none;} 
        #demoVideoDsk {display:block;} 
  }                
...
<!--            <div class="home-banner-tagline">
        ...
        <div class="row offering top35" style="background-color: transparent">
            <h1>What we do</h1>
            <div id="divDemoVideo" class="col-md-5 col-xs-12">
<!--                <iframe id="demoVideo" style="display:block; margin: 0 auto; margin-top: 5%; margin-bottom: 5%;"  width="100%" height="400" src="//www.youtube.com/embed/DkfdL72aUHg" frameborder="0" allowfullscreen></iframe>-->
                <iframe id="demoVideoDsk" src="//www.youtube.com/embed/DkfdL72aUHg" frameborder="0" allowfullscreen></iframe>
                <iframe id="demoVideoPhn" src="//www.youtube.com/embed/tmHxdZG0OqU" frameborder="0" allowfullscreen></iframe>
            </div>
            ...
            <div class="col-md-7 col-xs-12">
                ...
                <div class="col-md-12 col-xs-12" >
                    ...
                    <div class="right col-md-10 col-xs-10 no-left-padd">
