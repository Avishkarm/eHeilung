<?php 
  function getAllRemedies($conn, $remedyStatus=1, $startingLetter="") {
    global $blanks;
    $returnArr = array();

    $query = "SELECT * FROM remedies WHERE remedy_status='".$remedyStatus."'";
    if(!in_array($startingLetter, $blanks)){
      $query .= " AND remedy_name LIKE '".$startingLetter."%'";
    }
