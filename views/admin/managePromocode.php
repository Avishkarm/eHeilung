                ...
                <section class="content" >
                    <div class="pull-right" >
                           <div class="form-group">
                             <form method="post"  action="../../controllers/admin/promocodecrud/exportPromocodes.php">
                                    
                                    <input type="hidden" name="type" value="dashboard_reports">
                                      <input type="hidden" name="couponId" value="<?php echo $_GET['cid']; ?>">                        

                                    <button type="submit" class="btn btn-warning">
                                        <span style="margin-right:5px;" class="glyphicon glyphicon-export"></span>Export Excel
                                    </button>  
                            </form>
                                </div><!-- /.form group -->
                        </div>
        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    ...
                    actions: {
                        listAction: '<?php echo '../../controllers'; ?>/admin/promocodecrud/list.php?couponId=<?php echo $_GET['cid'];?>'
                    },
                    fields: {
                        promocodeId: {
                            key: true,
