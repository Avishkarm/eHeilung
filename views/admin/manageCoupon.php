        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    ...
                    actions: {
                        listAction: '<?php echo '../../controllers'; ?>/admin/couponcrud/list.php',
                        createAction: '<?php echo '../../controllers'; ?>/admin/couponcrud/create.php',
                        updateAction: '<?php echo '../../controllers'; ?>/admin/couponcrud/update.php',
                        deleteAction: '<?php echo '../../controllers'; ?>/admin/couponcrud/delete.php'
                    },
                    fields: {
                        couponId: {
                            key: true,
                        ...
                        {
                            var $input_expiry = data.form.find ('input[name="expiry"]');
                            $input_expiry.addClass("time");
                            $input_expiry.datepicker();
                        },*/
                        
                        MyButton: {
                            title: 'View promocodes',
                            width: '30%',
                            display: function(data) {
                                 return '<button type="button" onclick="setPricing(' + data.record.couponId + ')">View Promocodes</button> ';
                            }
                        },
                    },
            ...
            function setPricing(couponId){
                window.location.href="managePromocode.php?cid="+couponId;
            }
        </script>
