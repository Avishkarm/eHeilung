        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    title: 'All Remedies',
                    actions: {
                        listAction: '../../controllers/admin/remediescrud/list.php',
                        createAction: '../../controllers/admin/remediescrud/create.php',
                        updateAction: '../../controllers/admin/remediescrud/update.php',
                        deleteAction: '../../controllers/admin/remediescrud/delete.php'
                    },
                    fields: {
                        remedyId: {
                            title: 'Id',
