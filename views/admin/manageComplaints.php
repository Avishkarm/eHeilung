    ...
    <body class="skin-blue">
        ...
        <script>
            $(window).load(function () {
                    ...
                    actions: {
                        listAction: '../../controllers/admin/complaintscrud/list.php',
                        createAction: '../../controllers/admin/complaintscrud/create.php',
                        updateAction: '../../controllers/admin/complaintscrud/update.php',
                        deleteAction: '../../controllers/admin/complaintscrud/delete.php'
                    },
                    fields: {
                        id: {
                            //title: 'id',
