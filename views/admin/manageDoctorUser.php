        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    ...
                    actions: {
                        listAction: '<?php echo '../../controllers'; ?>/admin/doctoruserscrud/list.php'/*,
                        createAction: '<?php echo '../../controllers'; ?>/admin/planscrud/create.php',
                        updateAction: '<?php echo '../../controllers'; ?>/admin/planscrud/update.php',
                        deleteAction: '<?php echo '../../controllers'; ?>/admin/planscrud/delete.php'*/
                    },
                    fields: {
                        user_id: {
                            key: true,
                        ...
                        MyButton: {
                            ...
                            display: function(data) {
                                 return '<button type="button" onclick="setPricing(' + data.record.user_id + ')">View patients</button> ';
                            }
                        },
                    },
            ...
            function setPricing(user_id){
                window.location.href="managePatientUser.php?uid="+user_id;
            }
        </script>
