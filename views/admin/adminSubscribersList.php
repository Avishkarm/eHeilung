        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    ...
                    actions: {
                        listAction: '../../controllers/admin/subscribecrud/list.php'/*,
                        createAction: '../../controllers/admin/subscribecrud/create.php',
                        updateAction: '../../controllers/admin/subscribecrud/update.php',
                        deleteAction: '../../controllers/admin/subscribecrud/delete.php'*/
                    },
                    fields: {
                        s_id: {
                            key: true,
