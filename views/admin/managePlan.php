        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    ...
                    actions: {
                        listAction: '<?php echo '../../controllers'; ?>/admin/planscrud/list.php',
                    ...
                    fields: {
                        ...
                        MyButton: {
                            ...
                            display: function(data) {
                                 return '<button type="button" onclick="setPricing(' + data.record.planId + ')">Set Price</button> ';
                            }
                        },
                    },
            ...
            function setPricing(planId){
                window.location.href="managePrice.php?pid="+planId;
            }
        </script>
