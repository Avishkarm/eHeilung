...
<div id="remediesDialog" title="Remedies" style="display:none">
            ...
            <aside class="right-side"> 
                ...
                <section class="content" style="text-align: center;">
                    <div id="SensationTableContainer"></div>
                </section><!-- /.content -->
            </aside><!-- /.right-side -->
        </div><!-- ./wrapper -->
        <!-- jQuery 2.0.2 -->
        ...
        <script>
            $(window).load(function () {
                $('#SensationTableContainer').jtable({
                    title: 'All Sensations',
                    recordAdded: function(event, data){
                        window.location.href=window.location.href;
                    },
                    actions: {
                        listAction: '<?php echo '../../controllers'; ?>/admin/sensationcrud/list.php',
                        createAction: '<?php echo '../../controllers'; ?>/admin/sensationcrud/create.php',
                        updateAction: '<?php echo '../../controllers'; ?>/admin/sensationcrud/update.php',
                        deleteAction: '<?php echo '../../controllers'; ?>/admin/sensationcrud/delete.php'
                    },
                    fields: {
                        sensationId: {
                            key: true,
                        ...
                        sensationName: {
                            title: 'Sensation Name',
                            width: '40%'
                        },
                        sensationRemedies: {
                            title: 'Sensation Remedies',
                            width:'40%'
                        },
                        MyButton: {
                            ...
                            display: function(data) {
                                 return '<button type="button" onclick="setRemedies(' + data.record.sensationId + ', \'Sensation\')" >Manage Remedies</button> ';
                            }
                        }
                    },
                ...
                $('#SensationTableContainer').jtable("load");

            });
            

            function setRemedies(sensationId, type){
                window.location.href="manageSensationRemedies.php?sensationId="+sensationId+"&type="+type;  
            }
        </script>
