        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    ...
                    actions: {
                        listAction: '../../controllers/admin/2ndOpinionconclusioncrud/list.php',
                        createAction: '../../controllers/admin/2ndOpinionconclusioncrud/create.php',
                        updateAction: '../../controllers/admin/2ndOpinionconclusioncrud/update.php',
                        deleteAction: '../../controllers/admin/2ndOpinionconclusioncrud/delete.php'
                    },
                    fields: {
                        questionId: {
                            key: true,
                        ...
                        fh_g: {
                            title: 'First General',
                             options: {'Good':'Good','Bad':'Bad','noChange':'noChange'}
                           
                        },
                        fh_p: {
                            title: 'First Particular',
                             options: {'Good':'Good','Bad':'Bad','noChange':'noChange'}
                        },
                        fh_e: {
                        ...
                        fh_s: {
                            title: 'First half system',
                            options: {'Good':'Good','Bad':'Bad','Same':'Same'}
                        },
                        sh_s: {
                            title: 'Second half system',
                            options: {'Good':'Good','Bad':'Bad','Same':'Same'}
                        },
                        GetMedicine: {
                            title: 'Get Medicine',
