        ...
        <script>
           $(window).load(function () {
               // $(document).ready(function() {
                ...
                var baseurl = "http://localhost/hansinfo_eheilung/";
                $('#RubricsTableContainer').jtable({
                    ...
                    actions: {
                        listAction: '../../controllers/admin/doctorscrud/list.php',
                        createAction: '../../controllers/admin/doctorscrud/create.php',
                        updateAction: '../../controllers/admin/doctorscrud/update.php',
                        deleteAction: '../../controllers/admin/doctorscrud/delete.php'
                    ...
                    fields: {
                        ...
                        IMAGE:{
                             ...
                             display: function(data) {
                                 return '<div id="viewImage'+ data.record.doctorId +'"><img style="height:100px;" src="../../assets/uploads/'+ data.record.image +'" alt="Uploading...."/></div>';
                            } 
                        },
                        ...
                        MyButton: {
                            ...
                            list:true,
                            /*display: function(data) {
                                 return '<button type="button" onclick="setQuestions(' + data.record.rubricId + ')">Upload Image</button> ';
                            }*/
                            display: function(data) {
                            return '<div id='+ data.record.doctorId + '><form id="form'+ data.record.doctorId +'" method="post" enctype="multipart/form-data" action="../../controllers/admin/doctorscrud/imageUpload.php"><input type="file" name="photoimg" onchange="setQuestions(' + data.record.doctorId + ')" id="'+ data.record.doctorId +'" class="upload"/><input type="hidden" name="userId" value="'+ data.record.doctorId +'"/></form></div><div id="preview'+ data.record.doctorId +'"></div>';
                            }
                        }, 
           ...
           /*$('.upload').change(function(){
            ...
            function setQuestions(doctorId){
                 //var id=this.id;
                       $("#preview"+doctorId).html('');
                    $("#preview"+doctorId).html('');

                 $("#form"+doctorId).ajaxForm({
                        target: '#viewImage'+doctorId
                }).submit();
            }
