        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    title: '2nd Opinion Observations',
                    ...
                    actions: {
                        listAction: '../../controllers/admin/2ndOpinionobservationcrud/list.php',
                        createAction: '../../controllers/admin/2ndOpinionobservationcrud/create.php',
                        updateAction: '../../controllers/admin/2ndOpinionobservationcrud/update.php',
                        deleteAction: '../../controllers/admin/2ndOpinionobservationcrud/delete.php'
                    },
                    fields: {
                        observationId: {
                            key: true,
