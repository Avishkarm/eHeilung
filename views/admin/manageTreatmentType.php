        ...
        <script>
            $(window).load(function () {
                $('#RubricsTableContainer').jtable({
                    title: 'All Treatment Type',
                    recordAdded: function(event, data){
                        window.location.href=window.location.href;
                    },
                    actions: {
                        listAction: '../../controllers/admin/treatmentcrud/list.php',
                        createAction: '../../controllers/admin/treatmentcrud/create.php',
                        updateAction: '../../controllers/admin/treatmentcrud/update.php',
                        deleteAction: '../../controllers/admin/treatmentcrud/delete.php'
                    },
                    fields: {
                        treatmentId: {
                            key: true,
                        ...
                        MyButton: {
                            ...
                            display: function(data) {
                                 return '<button type="button" onclick="setSubtypes(' + data.record.treatmentId + ')">Set Subtypes</button> ';
                            }
                        },
                    },
            ...
            function setSubtypes(treatmentId){
                window.location.href="manage2ndOpinionQuestions.php?tid="+treatmentId;
            }
        </script>
