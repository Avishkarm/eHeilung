         ...
         <script>
            $(window).load(function () {
                ...
                $('#RubricsTableContainer').jtable({
                    title: 'All Treatment Subtypes',
                    recordAdded: function(event, data){
                        window.location.href=window.location.href;
                    },
                    actions: {
                        listAction: '../../controllers/admin/treatmentsubtypecrud/list.php?type_id='+type_id,
                        createAction: '../../controllers/admin/treatmentsubtypecrud/create.php?type_id='+type_id,
                        updateAction: '../../controllers/admin/treatmentsubtypecrud/update.php?type_id='+type_id,
                        deleteAction: '../../controllers/admin/treatmentsubtypecrud/delete.php?type_id='+type_id
                    },
                    fields: {
                        treatmentId: {
                            key: true,
