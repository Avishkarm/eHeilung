...
.chosen-container-single .chosen-single span {
    ...
    <link rel="stylesheet" type="text/css" href="../../assets/css/chosen.min.css">
      ...
      <div class="main-container">
          ...
          <div class="col-md-12 banner" style="margin: 0px 0px 30px 0px;" >
              ...
              <div class="col-md-12" style="" >
                  <h2>Check if you are on the right treatment path.</h2>
                  
                   <h3 class="bannerContent" style=""> Do you know which way your treatment is headed? Use the eHeilung software to see whether you are on right track or not This is a quick guide based on scientific principles of Embryology, Genetics, and laws of cure given by C.&nbsp;Hering and mentioned by German scientist S.&nbsp;Hahnemann.</h3>
                  </div>
                      <!-- Dropdown Starts -->
              <div class="col-md-12">
               <div class="col-md-6 col-sm-6" id="dropdown1" >
            <h3 for="complaint1">Past Complaint</h3>
            <select data-placeholder="Select" id="complaint1" type="text" class="form-control chosen-select"  value="drop1" > 
           
              <option> </option>
             <!--  <span style="margin-top: 3px;">Select</span> -->
              <?php
              foreach($complaintsQuery as $complaintsId=>$complaintsDetails)
              {
                ...
                $complaintsName1=stripcslashes(str_replace("\u00a0", "",cleanQueryParameter($conn,utf8_encode($complaintsDetails["Diagnostic_term"]))));
      ...
      $value=stripcslashes($value);*/
                ...
                {
                      $complaintsName=stripcslashes(str_replace("\u00a0", "",cleanQueryParameter($conn,utf8_encode($complaintsDetails1["Common_name"]))));
          ...
          <div class="col-md-6 col-sm-6" id="dropdown2">
            ...
            <select data-placeholder="Select" id="complaint2" class="form-control chosen-select"  value="drop2">
              ...
              foreach($complaintsQuery as $complaintsId=> $complaintsDetails)
              {
                ...
                //$complaintsName=utf8_encode($complaintsDetails["Common_name"]);
                $complaintsName1=stripcslashes(str_replace("\u00a0", "",utf8_encode($complaintsDetails["Diagnostic_term"])));
                $definition=stripcslashes(str_replace("\u00a0", "",cleanQueryParameter($conn,$complaintsDetails["Definition"])));
                $System=$complaintsDetails["system"];
                $Organ=$complaintsDetails["organ"];
                $Suborgan=$complaintsDetails["subOrgan"];
                ...
                foreach($complaintsQuery1 as $complaintsId1=>$complaintsDetails1)
                {
                      $complaintsName=stripcslashes(str_replace("\u00a0", "",utf8_encode($complaintsDetails1["Common_name"])));
                      $definition=stripcslashes(str_replace("\u00a0", "",cleanQueryParameter($conn,$complaintsDetails1["Definition"])));
                      $System=$complaintsDetails1["system"];
                      $Organ=$complaintsDetails1["organ"];
                      $Suborgan=$complaintsDetails1["subOrgan"];
        ...
        <div class="row" >
          <div id="conclusion" class="text-center">
            <div class="col-md-12 good"  id="good" style="background: url(../../assets/images/good.png);padding: 15px!important;background-size: cover;">
              <div class="text-center" >
                <div class="row"> <h1 class="head">Conclusion</h1></div>
              </div>
              <div>
                <p class="conclusionContent" style="text-align: left;">Well done! You are showing definite signs of improvement according to Hering’s Law.<br>Reasons:<br>Embrologically: The disease is going to organs of lesser importance<br>Genetically: The body is defending with the least burden<br>Morphogenetically: Symptoms are traveling from the Centre to periphery or downward.</p>
              </div>
            </div>
            <div class="col-md-12 bad"  id="bad" style="background: url(../../assets/images/bad.png); padding: 15px!important;background-size: cover;" >
              <div class="text-center" >
                <div class="row"> <h1 class="head">Conclusion</h1></div>
              </div>
              <div>
                <p class="conclusionContent"  style="text-align: left;">Your disease is most likely being suppressed according to Hering’s Law.<br>Reasons:<br>Embrologically: The disease is going to organs of greater importance<br>Genetically: The body is defending with higher burden<br> 
Morphogenetically: Symptoms are traveling to from the periphery to the centre or upward.</p>
              </div>
            </div>
            <div class="col-md-12 statusquo"  id="statusquo" style="background: url(../../assets/images/statusquo.png);padding: 15px!important;background-size: cover;">
              <div class="text-center" >
                <div class="row"> <h1 class="head">Conclusion</h1></div>
              </div>
              <div>
                <p class="conclusionContent "  style="text-align: left;">Your disease is showing signs of Stasis or of no change according to Hering’s Law.<br>Reasons:<br>Embrologically: The disease is going to organs of equal importance<br>Genetically: The body is defending with the same burden<br>Morphogenetically: Symptoms are static or not traveling to periphery.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  $("#conclusion").hide();
      ...
      function checkComplaint(comp1, comp2,i,data_miasm1_def,data_miasm2_def){
        ...
        if(complaintDieases[i][comp1[i]] < complaintDieases[i][comp2[i]]){
          ...
          if(i>=comp1.length-1 && i>=comp2.length-1){
            ...
            return checkComplaint(comp1, comp2, ++i,data_miasm1_def,data_miasm2_def);
          }
        }
      }
      $('.good').hide();
      ...
      $('#conclusion').hide(); 
        ...
        function calConclusion(){
          ...
          if(data_miasm1=='Syphilis'){
            data_miasm1_def = 'SYPHILIS:<br>'+'<?php echo $Syphilis; ?>';
          }else if(data_miasm1=='Sycosis'){
            data_miasm1_def = 'SYCOSIS  :<br>'+'<?php echo $Sycosis; ?>';
          }else if(data_miasm1=='Psora'){
            data_miasm1_def = 'PSORA:<br>'+'<?php echo $Psora; ?>';
          }

          if(data_miasm2=='Syphilis'){
            data_miasm2_def = 'SYPHILIS:<br>'+'<?php echo $Syphilis; ?>';
          }else if(data_miasm2=='Sycosis'){
            data_miasm2_def = 'SYCOSIS:<br>'+'<?php echo $Sycosis; ?>';
          }else if(data_miasm2=='Psora'){
            data_miasm2_def = 'PSORA:<br>'+'<?php echo $Psora; ?>';
          }
          ...
          if(selectedValue1 && selectedValue2){
            ...
            var dt= checkComplaint(newComp1, newComp2,0,data_miasm1_def,data_miasm2_def);
            res = dt[0];
