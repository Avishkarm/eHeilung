        ...
        <form name="secondform" method="post" id="secondform" action="">
          ...
          <div class="row particular">
            ...
            <div class="col-md-12" style="padding-left: 0px;" >
              ...
              <div class="quest">
                <div class="questHead">
                  <h3 class="questTitle">Medicine dosage <img src="../../assets/images/info.png" class="heading-info dosage"  /></h3>
                </div>
                <div class="ans11">
          ...
          <div class="row eliminations">
            ...
            <div class="col-md-12" style="padding-left: 0px;" >
              ...
              <div class="quest">
                <div class="questHead">
                  <h3 class="questTitle">Mild Diarrhoea <img src="../../assets/images/info.png" class="heading-info diarrhoea" data-toggle="modal" data-target="#infoModal" /></h3>
                </div>
                <div class="ansdiv">
                  <div class="ans11">
          ...
          <div class="row complaint">
            <div class="col-md-12">
               <div class="otherComplaint text-center"><h3 style="letter-spacing: 1px;margin-bottom: 5%;word-spacing: 1px;font-size: 26px;">Do you face any additional problem during second <?php if(!empty($year) && $year!=0 ){ echo $year." year ";} if(!empty($month) && $month!=0 ){ echo $month." month ";} if(!empty($day) && $day!=0 ){ echo $day." day";}?>?</h3></div>
            </div>
     ...
     $('.next-btn').click(function () {   
      ...
      var $elems = $(".quest");
        ...
        if(i >= $elems.length) 
        {
              ...
              var decodedUri1 = decodeURIComponent(startform);
              var array1 = decodedUri1.replace(/\&/g, '<br/>');

              $("#start").val(startform);

              var firstform = localStorage.getItem('firstform');
              var decodedUri2 = decodeURIComponent(firstform);
              var array2 = decodedUri2.replace(/\&/g, '<br/>');
            
              $("#fsthalf").val(firstform);

              var secondform = localStorage.getItem('secondform');
              var decodedUri3 = decodeURIComponent(secondform);
