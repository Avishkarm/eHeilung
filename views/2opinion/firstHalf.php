  ...
  .heading-info {
    ...
    <link rel="stylesheet" type="text/css" href="../../assets/css/chosen.min.css">
      ...
      <div class="main-container">
        <form name="firstform" method="post" id="firstform" action="">
         <!--  <div class="row">
          ...
          <div class="row">
            <div class="col-md-12 fsthalf" style="margin-top: 10%;" >
             <img src="../../assets/images/1stHalf.png" style="width: 100%;" class="img-responsive">
             <h4>This disease has two phases, each lasting for <?php if(!empty($year) && $year!=0 ){ echo $year." year ";} if(!empty($month) && $month!=0 ){ echo $month." month ";} if(!empty($day) && $day!=0 ){ echo $day." day";}?>. We have prepared a list of questions to see what's your health condition during these two phases. This is absolutely FREE. Let's start from the First Half (first <?php if(!empty($year) && $year!=0 ){ echo $year." year ";} if(!empty($month) && $month!=0 ){ echo $month." month ";} if(!empty($day) && $day!=0 ){ echo $day." day";}?>)</h4>
            </div>
          </div>
          <div class="row generals">
            ...
            <div class="col-md-12" style="padding-left: 0px;" >
              ...
              <div class="quest">
                ...
                <div class="ans1">
                  <input type="radio" id="Stool[0]" name="input[generals][Stool]" value="good" required="">
                  <label class="event" for="Stool[0]">Better</label>
                </div>
                <div class="ans2">
                  <input type="radio" id="Stool[1]" name="input[generals][Stool]" value="bad" required="">
                  <label class="event" for="Stool[1]">Worse</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Stool[2]" name="input[generals][Stool]" value="nochange" required="">
              ...
              <div class="quest">
                ...
                <div class="ans1">
                  <input type="radio" id="Urine[0]" name="input[generals][Urine]" value="good" required="">
                  <label class="event" for="Urine[0]">Better</label>
                </div>
                <div class="ans2">
                  <input type="radio" id="Urine[1]" name="input[generals][Urine]" value="bad" required="">
                  <label class="event" for="Urine[1]">Worse</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Urine[2]" name="input[generals][Urine]" value="nochange" required="">
              ...
              <div class="quest">
                ...
                <div class="ans1">
                  <input type="radio" id="Menses[0]" name="input[generals][Menses]" value="good" required="">
                  <label class="event" for="Menses[0]">Better</label>
                </div>
                <div class="ans2">
                  <input type="radio" id="Menses[1]" name="input[generals][Menses]" value="bad" required="">
                  <label class="event" for="Menses[1]">Worse</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Menses[2]" name="input[generals][Menses]" value="nochange" required="">
          ...
          <div class="row particular">
            <div class="col-md-12 text-center" style="" >
             ...
             <h1 style="    font-weight: 600;letter-spacing: 1px;"><?php echo $complaint; ?><!-- <img src="../../assets/images/info.png" class="heading-info" data-toggle="modal" data-target="#infoModal" /> --></h1>
            </div>
            <div class="col-md-12" style="padding-left: 0px;" >
              <div class="col-md-6 col-sm-6">
              <div class="quest">
              ...
              <div class="quest">
                ...
                <div class="ans11">
                  <input type="radio" id="Frequency[0]" name="input[particular][Frequency]" value="bad" required="">
                  <label class="event1" for="Frequency[0]">Increased</label>
                </div>
                <div class="ans21">
                  <input type="radio" id="Frequency[1]" name="input[particular][Frequency]" value="good" required="">
                  <label class="event1" for="Frequency[1]">Decreased</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Frequency[2]" name="input[particular][Frequency]" value="nochange" required="">
              ...
              <div class="quest">
                ...
                <div class="ans11">
                  <input type="radio" id="Recovery_period[0]" name="input[particular][Recovery_period]" value="bad" required="">
                  <label class="event1" for="Recovery_period[0]">Increased</label>
                </div>
                <div class="ans21">
                  <input type="radio" id="Recovery_period[1]" name="input[particular][Recovery_period]" value="good" required="">
                  <label class="event1" for="Recovery_period[1]">Decreased</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Recovery_period[2]" name="input[particular][Recovery_period]" value="nochange" required="">
          ...
          <div class="row eliminations">
            ...
            <div class="col-md-12" style="padding-left: 0px;" >
              ...
              <div class="quest">
                ...
                <div class="ansdiv">
                  <div class="ans11">
                    <input type="radio" id="Mild_Diarrhoea[0]" name="input[eliminations][Mild_Diarrhoea]" value="good" required="">
                    <label class="event1" for="Mild_Diarrhoea[0]">Appeared</label>
                  </div>
                  <div class="ans12" style="">
                    <input type="radio" id="Mild_Diarrhoea[1]" name="input[eliminations][Mild_Diarrhoea]" value="bad" required="">
                    <label class="event1" for="Mild_Diarrhoea[1]">Not appeared</label>
                  </div>
                  <div class="ans3">
                    <input type="radio" id="Mild_Diarrhoea[2]" name="input[eliminations][Mild_Diarrhoea]" value="nochange" required="">
              ...
              <div class="quest">
                ...
                <div class="ans11">
                  <input type="radio" id="Itching[0]" name="input[eliminations][Itching]" value="good" required="">
                  <label class="event1" for="Itching[0]">Appeared</label>
                </div>
                <div class="ans12">
                  <input type="radio" id="Itching[1]" name="input[eliminations][Itching]" value="bad" required="">
                  <label class="event1" for="Itching[1]">Not appeared</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Itching[2]" name="input[eliminations][Itching]" value="nochange" required="">
              ...
              <div class="quest">
                ...
                <div class="ans11">
                  <input type="radio" id="Leakage[0]" name="input[eliminations][Leakage]" value="good" required="">
                  <label class="event1" for="Leakage[0]">Appeared</label>
                </div>
                <div class="ans12">
                  <input type="radio" id="Leakage[1]" name="input[eliminations][Leakage]" value="bad" required="">
                  <label class="event1" for="Leakage[1]">Not appeared</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Leakage[2]" name="input[eliminations][Leakage]" value="nochange" required="">
              ...
              <div class="quest">
                ...
                <div class="ans11">
                  <input type="radio" id="Cough[0]" name="input[eliminations][Cough]" value="good" required="">
                  <label class="event1" for="Cough[0]">Appeared</label>
                </div>
                <div class="ans12">
                  <input type="radio" id="Cough[1]" name="input[eliminations][Cough]" value="bad" required="">
                  <label class="event1" for="Cough[1]">Not appeared</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Cough[2]" name="input[eliminations][Cough]" value="nochange" required="">
              ...
              <div class="quest">
                ...
                <div class="ans11">
                  <input type="radio" id="Fever[0]" name="input[eliminations][Fever]" value="good" required="">
                  <label class="event1" for="Fever[0]">Appeared</label>
                </div>
                <div class="ans12">
                  <input type="radio" id="Fever[1]" name="input[eliminations][Fever]" value="bad" required="">
                  <label class="event1" for="Fever[1]">Not appeared</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Fever[2]" name="input[eliminations][Fever]" value="nochange" required="">
              ...
              <div class="quest">
                ...
                <div class="ans11">
                  <input type="radio" id="Discharge[0]" name="input[eliminations][Discharge]" value="good" required="">
                  <label class="event1" for="Discharge[0]">Appeared</label>
                </div>
                <div class="ans12">
                  <input type="radio" id="Discharge[1]" name="input[eliminations][Discharge]" value="bad" required="">
                  <label class="event1" for="Discharge[1]">Not appeared</label>
                </div>
                <div class="ans3">
                  <input type="radio" id="Discharge[2]" name="input[eliminations][Discharge]" value="nochange" required="">
          ...
          <div class="row complaint">
           <div class="col-md-12">
             <div class="otherComplaint text-center"><h3 style="letter-spacing: 1px;margin-bottom: 5%;word-spacing: 1px;font-size: 26px;">Do you face any additional problem during first <?php if(!empty($year) && $year!=0 ){ echo $year." year ";} if(!empty($month) && $month!=0 ){ echo $month." month ";} if(!empty($day) && $day!=0 ){ echo $day." day";}?>?</h3></div>
            </div>
            <div class="col-md-12 complaintsDetails" style="" >
              ...
              <div class="quest" style="border-bottom: none;">
                <div class="complaintAns">
                  <div class="ans1">
                  <input type="radio" class="addProblem1" id="complaint[0]" name="problem1" value="yes" required="">
                  <label class="event2" for="complaint[0]">Yes</label>
                </div>
                <div class="ans22">
                  <input type="radio" class="addProblem1" id="complaint[1]" name="problem1" value="no" required="">
                  <label class="event2" for="complaint[1]">No</label>
                </div>
                <div class="ans3">
                  <input type="radio" class="addProblem1" id="complaint[2]" name="problem1" value="nochange" required="">
                  <label class="event2" for="complaint[2]">Don't know</label>
                </div>
                </div>
                </div>
                <div class="complaintBox mainComplaint" id="mainComplaint" >
                  <select class="chosen-select form-control" placeholder="Select" required="" type="text" id="complaint" name="fstcomplaint[]" multiple="" style="padding: 5px;">
                    <?php
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center;margin-top:80px;" >
                  ...
                  <a id="" class="next-btn"><img src="../../assets/images/nextbtn.png"></a>
...
<script type="text/javascript">
  ...
  $('#mainComplaint').hide();
   ...
   $(".addProblem1").change(function () {
                
        var selectedValue=$("input[name='problem1']:checked"). val();
   ...
   $('#errorMsg').hide();
    ...
    {    
       var selectedValue1=$("input[name='problem1']:checked"). val();
       if(selectedValue1=='yes')
        ...
        (function fetch(i)
        {
            ...
            if(i >= $elems.length) 
            {
              ...
              var datastring = $("#firstform").serialize();
              localStorage.setItem('firstform', datastring);
              window.location.href='secondHalf.php?year='+<?php echo $year;?>+'&month='+<?php echo $month;?>+'&day='+<?php echo $day;?>+'&complaint='+"<?php echo $complaint;?>";
               return false;           
            }
...
function titleCase(str) {
  ...
  /*$('.next-btn').click(function() {
        window.location.href = 'secondHalf.php';
  });*/
</script>
</body>
