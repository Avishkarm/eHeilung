...
<script type="text/javascript">
	...
	$(".submit-btn").click(function(){
		...
		if(allVals==""){
           ...
           {
           	 var y_value=100;
           	 var result="<div class='col-md-12' style='padding: 0 40px 40px 40px;'><h3>You've undergone and have endured a lot. Body is now showing pathological effects of stress from your life experiences. In allopathic system of medicine theres not much that can be offerred apart from some mood elevator or depressor that only works superficially and temporarily making you dependent and addicted to drugs. Get a homeopathic consultation now.</h3></div>"
           	 //$('#score').html(score);
          	$('#score-result').html(result);
           }
			    ...
			    plotOptions: {
			        solidgauge: {
			          ...
			          style: {
			           ...
			           formatter: function() {
			            var sScore = score;
                                        var tScore = <?php echo $totalScore; ?>;
                                        //alert(sScore);
                                        //alert(tScore);
                                        var pcnScore = ((sScore / tScore) * 100).toFixed(2);
                                        //alert(pcnScore);
                                        return '<div style="width:100%;text-align:center;font-size: 33px;margin-left: 2px;"><span color:' + Highcharts.getOptions().colors[ColorIndex] + '!important;font-weight:bold;font-size: 33px!important;margin-left: 18px;">' + pcnScore + ' %</span>';	
