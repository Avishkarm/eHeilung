...
if(noError($patientInfo)){
  ...
  $caseSheet = getsectionrubrics(Causation,$usergroup,$gender,$age, $conn);
//printArr($caseSheet2);
...
$updateStepNo=updateStepNo($case_id,4,$conn);
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../../assets/css/chosen.min.css">
      ...
      <div class="main-container">
         ...
         <form action="javascript:;" name="step6Form" id="step6Form" method="post" enctype="multipart/form-data" >
          ...
          <input type="hidden" name="step_no" class="step_no" value="4">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center;margin-top:80px;" >
                  ...
                  <button style="outline:0;border: none; background-color: transparent;" id="step6submit" type="submit" class="next-btn"><img src="../../assets/images/nextbtn.png"/></button>
 ...
 <?php include("../modals.php"); //KDR-ALERT ?> 
...
<script type="text/javascript">
  ...
  $('form#step6Form').submit(function(event) {
    var case_id=<?php echo $_GET['case_id']; ?>;
    //alert($('.step_no').val());
